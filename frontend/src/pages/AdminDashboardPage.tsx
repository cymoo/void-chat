...
export function AdminDashboardPage() {
  ...
  const loadDashboard = useCallback(async () => {
    ...
    try {
      ...
      setDashboard(data);
      setRoleDrafts(Object.fromEntries(data.users.map((u) => [u.id, u.role ?? "user"])));
    } catch (e) {
      const message =
        ...
        <div className="admin-dashboard-header">
          <div>
            ...
            <div className="admin-dashboard-subtitle">
              Platform roles, moderation, invites, and room overview
            </div>
          </div>
            ...
            <section className="admin-card">
              ...
              <div className="admin-user-filters">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setStateFilter(
                      e.target.value as UserStateFilter,
                    )
                  }
                >
                    ...
                    invites.map((invite) => (
                      <div key={invite.id} className="admin-invite-item">
                        ...
                        <div className="admin-invite-meta">
                          ...
                          <span>BY: {invite.createdByUsername ?? `#${invite.createdByUserId}`}</span>
                        </div>
                      </div>
                    ))
                  )}
                    ...
                    return (
                      <div key={room.id} className="admin-room-item">
                        ...
                        <div className="admin-room-item-meta">
                          ...
                          <span>CAPACITY: {room.onlineUsers}/{room.maxUsers}</span>
                        </div>
                        {room.description && (
